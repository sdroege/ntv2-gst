...
#ifndef _GST_AJA_SINK_COMBINER_H_
#define _GST_AJA_SINK_COMBINER_H_
...
#define GST_TYPE_AJA_SINK_COMBINER \
  (gst_aja_sink_combiner_get_type())
#define GST_AJA_SINK_COMBINER(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_AJA_SINK_COMBINER,GstAjaSinkCombiner))
#define GST_AJA_SINK_COMBINER_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_AJA_SINK_COMBINER,GstAjaSinkCombinerClass))
...
#endif /* _GST_AJA_SINK_COMBINER_H_ */
