...
#define AJA_NTV2_SDK_VERSION_POINT		4			///< @brief	The SDK "point" release version, an unsigned decimal integer.
#define AJA_NTV2_SDK_BUILD_NUMBER		1			///< @brief	The SDK build number, an unsigned decimal integer.
#define AJA_NTV2_SDK_BUILD_DATETIME		"Tue May 26 16:49:24 UTC 2020"		///< @brief	The date and time the SDK was built, in this format: "MM/DD/YYYY +8:hh:mm:ss"
