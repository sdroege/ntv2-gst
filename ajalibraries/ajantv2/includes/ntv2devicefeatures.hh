...
/**
	@brief		Returns true if the device having the given ID uses version 5 SPI hardware.
	@param[in]	inDeviceID		Specifies the NTV2DeviceID of interest.
**/
AJAExport bool NTV2DeviceHasSPIv5 (const NTV2DeviceID inDeviceID);

/**
	@brief		Returns true if the device supports an audio mixer (firmware dependent).
	@param[in]	inDeviceID		Specifies the NTV2DeviceID of interest.
**/
